...
const std::vector<std::string> vaiTargets {"DPUCAHX8H-u50", "DPUCAHX8H-u280", "DPUCAHX8L-u50", "DPUCAHX8L-u280"};

#elif defined(USE_VART_CLOUD_DPU)
const std::vector<std::string> vaiTargets {"DPUCAHX8H-u50", "DPUCAHX8H-u280", "DPUCAHX8L-u50", "DPUCAHX8L-u280","DPUCADF8H", "DPUCVDX8H"};
