...
from pyxir.shared.hash_map import HashMap, MapStrStr, MapStrVectorStr
from pyxir.shared.vector import Vector, StrVector, IntVector,\
    FloatVector, IntVector2D


class XAttrDict(object):
