...
from pyxir.graph.optimization.xgraph_base_optimizer import\
    XGraphBaseOptimizer
from pyxir.graph.optimization.xgraph_optimization_pass import\
    XGraphOptimizationPass

logger = logging.getLogger("pyxir")


class ExternalQOptimizer(XGraphBaseOptimizer):

    """
    Optimizer built for external quantization tools
    """

    def __init__(self, xgraph):
        super(ExternalQOptimizer, self).__init__(xgraph)
