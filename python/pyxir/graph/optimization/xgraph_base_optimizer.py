...
class XGraphBaseOptimizer(object):
    ...
    ---------
    xgraph: XGraph
        the XGraph object to be optimized
    copy: boolean
        whether to perform the optimizations on a copy of the XGraph
        object or on the original XGraph object
    """
    ...
    def optimize(self) -> XGraph:
        ...
        for idx, (level, opt_passes) in enumerate(
            ...
            logger.info("Optimization pass: {} level: {}: nb: {}"
