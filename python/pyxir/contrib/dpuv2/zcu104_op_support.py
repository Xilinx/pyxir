...
@pyxir.register_op_support_check('dpuv2-zcu104', 'BatchNorm')
...
@pyxir.register_op_support_check('dpuv2-zcu104', 'BiasAdd')
...
@pyxir.register_op_support_check('dpuv2-zcu104', 'Concat')
...
@pyxir.register_op_support_check('dpuv2-zcu104', 'Convolution')
...
@pyxir.register_op_support_check('dpuv2-zcu104', 'Conv2DTranspose')
...
# @pyxir.register_op_support_check('dpuv2-zcu104', 'Dense')
...
@pyxir.register_op_support_check('dpuv2-zcu104', 'DPUV2')
...
@pyxir.register_op_support_check('dpuv2-zcu104', 'Eltwise')
...
@pyxir.register_op_support_check('dpuv2-zcu104', 'Pad')
...
@pyxir.register_op_support_check('dpuv2-zcu104', 'Pooling')
...
@pyxir.register_op_support_check('dpuv2-zcu104', 'Mean')
...
@pyxir.register_op_support_check('dpuv2-zcu104', 'LeakyReLU')
...
@pyxir.register_op_support_check('dpuv2-zcu104', 'pReLU')
...
@pyxir.register_op_support_check('dpuv2-zcu104', 'ReLU')
...
@pyxir.register_op_support_check('dpuv2-zcu104', 'ReLU6')
...
@pyxir.register_op_support_check('dpuv2-zcu104', 'Scale')
...
@pyxir.register_op_support_check('dpuv2-zcu104', 'Upsampling2D')
def scale_op_support(X, bXs, tXs):
    # Type: (XLayer, List[XLayer], List[XLayer]) -> boolean
