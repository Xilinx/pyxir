...
def xgraph_dpu_v2_ultra96_build_func(xgraph, work_dir=os.getcwd(), **kwargs):
...
def xgraph_dpu_v2_ultra96_compiler(xgraph, **kwargs):
...
pyxir.register_target('dpuv2-ultra96',
                      ...
                      xgraph_dpu_v2_ultra96_compiler,
                      xgraph_dpu_v2_ultra96_build_func)
