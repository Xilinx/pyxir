...
"""Module for registering DPUCVDX8G target"""
...
def xgraph_dpu_build_func(xgraph, work_dir=os.getcwd(), **kwargs):
    return subgraph.xgraph_build_func(
        xgraph=xgraph, target="DPUCVDX8G", xtype="DPU", layout="NHWC", work_dir=work_dir
    )


def xgraph_dpu_compiler(xgraph, **kwargs):
    # Vitis-AI 1.3 - ...
    new_arch = "/opt/vitis_ai/compiler/arch/DPUCVDX8G/VCK190/arch.json"
