...
"""
Module for declaring and specifying supported operations for the DPUCAHX8H-u55c target.
...
@pyxir.register_op_support_check("DPUCAHX8H-u55c", "BatchNorm")
def batchnorm_op_support(X: XLayer, bXs: List[XLayer], tXs: List[XLayer]) -> bool:
    ...
    on the DPUCAHX8H-u55c target"""
    return is_batch_norm_supported(X, bXs, tXs, channel_parallel=16, bank_depth=2048)


@pyxir.register_op_support_check("DPUCAHX8H-u55c", "BiasAdd")
...
@pyxir.register_op_support_check("DPUCAHX8H-u55c", "Cast")
...
@pyxir.register_op_support_check("DPUCAHX8H-u55c", "Concat")
...
@pyxir.register_op_support_check("DPUCAHX8H-u55c", "Convolution")
...
@pyxir.register_op_support_check("DPUCAHX8H-u55c", "Conv2DTranspose")
...
@pyxir.register_op_support_check("DPUCAHX8H-u55c", "DPU")
...
@pyxir.register_op_support_check("DPUCAHX8H-u55c", "Eltwise")
...
@pyxir.register_op_support_check("DPUCAHX8H-u55c", "Maximum")
...
@pyxir.register_op_support_check("DPUCAHX8H-u55c", "Pad")
...
@pyxir.register_op_support_check("DPUCAHX8H-u55c", "Pooling")
...
@pyxir.register_op_support_check("DPUCAHX8H-u55c", "Mean")
...
@pyxir.register_op_support_check("DPUCAHX8H-u55c", "LeakyReLU")
...
@pyxir.register_op_support_check("DPUCAHX8H-u55c", "pReLU")
...
@pyxir.register_op_support_check("DPUCAHX8H-u55c", "ReLU")
...
@pyxir.register_op_support_check("DPUCAHX8H-u55c", "ReLU6")
...
@pyxir.register_op_support_check("DPUCAHX8H-u55c", "Scale")
...
@pyxir.register_op_support_check("DPUCAHX8H-u55c", "Upsampling2D")
...
@pyxir.register_op_support_check("DPUCAHX8H-u55c", "Dropout")
