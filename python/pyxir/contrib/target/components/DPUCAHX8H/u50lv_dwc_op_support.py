...
"""
Module for declaring and specifying supported operations for the DPUCAHX8H-u50lv_dwc target.
...
@pyxir.register_op_support_check("DPUCAHX8H-u50lv_dwc", "BatchNorm")
def batchnorm_op_support(X: XLayer, bXs: List[XLayer], tXs: List[XLayer]) -> bool:
    ...
    on the DPUCAHX8H-u50lv_dwc target"""
    return is_batch_norm_supported(X, bXs, tXs, channel_parallel=16, bank_depth=2048)


@pyxir.register_op_support_check("DPUCAHX8H-u50lv_dwc", "BiasAdd")
...
@pyxir.register_op_support_check("DPUCAHX8H-u50lv_dwc", "Cast")
...
@pyxir.register_op_support_check("DPUCAHX8H-u50lv_dwc", "Concat")
...
@pyxir.register_op_support_check("DPUCAHX8H-u50lv_dwc", "Convolution")
...
@pyxir.register_op_support_check("DPUCAHX8H-u50lv_dwc", "Conv2DTranspose")
...
@pyxir.register_op_support_check("DPUCAHX8H-u50lv_dwc", "DPU")
...
@pyxir.register_op_support_check("DPUCAHX8H-u50lv_dwc", "Eltwise")
...
@pyxir.register_op_support_check("DPUCAHX8H-u50lv_dwc", "Maximum")
...
@pyxir.register_op_support_check("DPUCAHX8H-u50lv_dwc", "Pad")
...
@pyxir.register_op_support_check("DPUCAHX8H-u50lv_dwc", "Pooling")
...
@pyxir.register_op_support_check("DPUCAHX8H-u50lv_dwc", "Mean")
...
@pyxir.register_op_support_check("DPUCAHX8H-u50lv_dwc", "LeakyReLU")
...
@pyxir.register_op_support_check("DPUCAHX8H-u50lv_dwc", "pReLU")
...
@pyxir.register_op_support_check("DPUCAHX8H-u50lv_dwc", "ReLU")
def relu_op_support(X: XLayer, bXs: List[XLayer], tXs: List[XLayer]) -> bool:
    ...
    return bX.type[0] in set(
        ["Convolution", "Conv2DTranspose", "BatchNorm", "BiasAdd", "Scale"]
    )


@pyxir.register_op_support_check("DPUCAHX8H-u50lv_dwc", "ReLU6")
...
@pyxir.register_op_support_check("DPUCAHX8H-u50lv_dwc", "Scale")
...
@pyxir.register_op_support_check("DPUCAHX8H-u50lv_dwc", "Upsampling2D")
...
@pyxir.register_op_support_check("DPUCAHX8H-u50lv_dwc", "Dropout")
