...
""" Module for registering DPUCAHX8H u280 target """
...
def xgraph_dpu_u55c_build_func(xgraph, work_dir=os.getcwd(), **kwargs):
...
def xgraph_dpu_u55c_compiler(xgraph, **kwargs):

    # Vitis-AI 2.0 - ...
    arch = "/opt/vitis_ai/compiler/arch/DPUCAHX8H/U55C/arch.json"
