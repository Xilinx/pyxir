...
from pyxir.target import Target
...
class TestTargetRegistry(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.target_registry.register_target('test',
                                            xgraph_optimizer,
                                            xgraph_quantizer,
                                            xgraph_compiler,
                                            xgraph_build_func)
    ...
    def test_initialization(self):
        self.assertTrue(
            set(TestTargetRegistry.target_registry.get_target_names()) ==
            set(['cpu', 'test'])
        )
    ...
    def test_register_target_twice(self):
        ...
        with self.assertRaises(ValueError) as context:
            ...
            self.assertTrue("Target: test is already registered." in
    ...
    def test_get_target(self):
        ...
        with self.assertRaises(ValueError) as context:
            ...
            self.assertTrue("notarget is not registered" in
                            str(context.exception))
