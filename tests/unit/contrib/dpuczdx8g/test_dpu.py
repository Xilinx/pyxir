...
class TestDPUContrib(unittest.TestCase):
    ...
    def test_supported_ops(self):
        ultra96_ops = TestDPUContrib.target_registry.get_supported_op_check_names(
            "dpuv2-ultra96"
        )
        ...
        zcu102_ops = TestDPUContrib.target_registry.get_supported_op_check_names(
            "dpuv2-zcu102"
        )
        ...
        zcu104_ops = TestDPUContrib.target_registry.get_supported_op_check_names(
            "dpuv2-zcu104"
        )
        ...
        som_ops = TestDPUContrib.target_registry.get_supported_op_check_names(
            "dpuv2-som"
        )
    ...
    def test_small(self):
        ...
        dpu_xgraph = TestDPUContrib.target_registry.get_target_build_func(
            "dpuv2-zcu104"
        )(p_xgraph)
