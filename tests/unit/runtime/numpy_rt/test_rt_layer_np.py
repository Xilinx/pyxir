...
class TestXfDNNTFOperations(unittest.TestCase):
    ...
    def test_constant_layer(self):
        layers = [
            ConstantLayer(
                ...
                input_shapes=[],
                subgraph=None,
                value=np.array([1, -1, 0, 4, -5, 1, 0, 8, 3, -5, 1, 0, 1,
                                9, -3, -4],
                               dtype=np.float32)
            )
        ]
        ...
        expected_outpt = np.array([1, -1, 0, 4, -5, 1, 0, 8, 3, -5, 1, 0,
                                   1, 9, -3, -4],
                                  dtype=np.float32)
    ...
    def test_relu(self):
        ...
        inputs = [np.reshape(
                        np.array([1, -1, 0, 4, -5, 1, 0, 8, 3, -5, 1, 0,
                                  1, 9, -3, -4],
                                 dtype=np.float32),
                        (1, 1, 4, 4))]
        for layer in layers:
    ...
    def test_squeeze_layer(self):
        ...
        inpt = np.reshape(np.array([1, -1, 0, 4, -5, 1, 0, 8, 3, -5, 1, 0,
                                    1, 9, -3, -4],
                                   dtype=np.float32),
                          (1, 1, 1, 4, 4))
        ...
        expected_outpt = np.reshape(np.array([1, -1, 0, 4, -5, 1, 0, 8, 3, -5,
                                              1, 0, 1, 9, -3, -4],
                                             dtype=np.float32),
                                    (1, 4, 4))
