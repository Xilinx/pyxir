...
class TestL1BasicNN(unittest.TestCase):
    ...
    def test_expand_dims_positive_axis(self):
        ...
        edX = xlf.get_xop_factory_func('ExpandDims')('ed1', [iX],
                                                     axis=0,
                                                     num_newaxis=2)
        ...
        edX = xlf.get_xop_factory_func('ExpandDims')('ed2', [iX],
                                                     axis=1,
                                                     num_newaxis=2)
        ...
        edX = xlf.get_xop_factory_func('ExpandDims')('ed3', [iX],
                                                     axis=2,
                                                     num_newaxis=2)
        ...
        with self.assertRaises(AssertionError):
            edX = xlf.get_xop_factory_func('ExpandDims')('ed4', [iX],
                                                         axis=3,
                                                         num_newaxis=2)
