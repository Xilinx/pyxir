...
class TestL3MathAndTransformations(unittest.TestCase):
    ...
    def test_relu6_layer(self):
        ...
        sX = px.ops.clip('clip1', iX, a_min=0., a_max=6.)
    ...
    def test_split_layer_int(self):
        ...
        assert sX.shapes == TupleShape([TensorShape([1, 2, 4, 4]),
                                        TensorShape([1, 2, 4, 4]),
                                        TensorShape([1, 2, 4, 4])])
    ...
    def test_split_layer_tuple(self):
        ...
        assert sX.type[0] == 'Split'
        assert sX.shapes == TupleShape([TensorShape([1, 1, 4, 4]),
                                        TensorShape([1, 3, 4, 4]),
                                        TensorShape([1, 1, 4, 4])])
